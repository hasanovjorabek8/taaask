...
class CyberSecurityCourse extends StatefulWidget {
  const CyberSecurityCourse({super.key});

  @override
  State<CyberSecurityCourse> createState() => _CyberSecurityCourseState();
}

class _CyberSecurityCourseState extends State<CyberSecurityCourse> {
