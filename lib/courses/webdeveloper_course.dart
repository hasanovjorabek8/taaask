...
class WebDeveloperCourse extends StatefulWidget {
  const WebDeveloperCourse({super.key});

  @override
  State<WebDeveloperCourse> createState() => _WebDeveloperCourseState();
}

class _WebDeveloperCourseState extends State<WebDeveloperCourse> {
